...
void searchcustomer::on_gobutton_clicked()
{
    ...
    qry.bindValue(":customer",ui->customeredit->text().toUpper());
    if(!qry.exec())
    {
        qDebug() << qry.lastError();
        qDebug()<<"Customer Search Error";
    }
    else
    {
        qDebug( "Executed" );
    ...
    if(temp_flag==0)
    {
        QMessageBox::critical(this, "Invalid Customer", "Customer doesn't Exists!!");
        ui->displayedit->clear();
        ui->printbutton->setDisabled(1);
        ui->nextbutton->setDisabled(1);
        ui->previousbutton->setDisabled(1);
...
void searchcustomer::on_printbutton_clicked()
{
    QPrinter printer;
...
void searchcustomer::on_clearbutton_clicked()
{
    ui->displayedit->clear();
...
void searchcustomer::on_previousbutton_clicked()
{
    if(qry.previous())
    {
        ui->nextbutton->setEnabled(1);
...
void searchcustomer::on_nextbutton_clicked()
{
    if(qry.next())
    {
